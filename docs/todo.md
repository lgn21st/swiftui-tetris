...
- [ ] Add an explicit per-connection maximum queued-output byte count before any non-localhost transport is considered.
...
- Keep `docs/adapter.md` normative for wire behavior and `docs/rules-spec.md` normative for gameplay.
