...
## Status
Core and optional features are implemented and covered by tests, including soft drop trail, active-piece highlight textures, lock-bar warning pulse, and board gridlines.
